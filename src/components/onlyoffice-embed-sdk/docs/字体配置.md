...
| `src/components/onlyoffice-embed-sdk/scripts/fonts/ttf-to-catalog-font.mjs` | 组件库内副本，便于版本管理 |
...
- [ ] 部署后静态资源路径与 `STATIC_RESOURCE.onlyoffice.root` 一致（CDN 模式通过 `registerStaticResource({ cdnOrigin })` 配置）
