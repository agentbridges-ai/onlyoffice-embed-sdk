...
application's release manifest. For SDK `0.1.0`, the expected identity is:
...
`sdk-v0.1.0`. Before the first real release, an organization owner must:
...
4. Push a GitHub-verified signed annotated `sdk-v0.1.0` tag. The workflow then
