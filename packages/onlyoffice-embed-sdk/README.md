...
application's release manifest. For SDK `0.1.1`, the expected identity is:
...
`sdk-v0.1.1`. Before the first real release, an organization owner must:
...
4. Push a GitHub-verified signed annotated `sdk-v0.1.1` tag. The workflow then
